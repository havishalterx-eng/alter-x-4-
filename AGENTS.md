...
An autonomous execution platform with two modes: **Workflow Mode** (build, run
and maintain business workflows) and **Project Mode** (build, test, deploy and
maintain software), on one shared Engine. `README.md` has the overview and
