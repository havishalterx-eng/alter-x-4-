...
export const versionStatuses = ["draft", "scanning", "scan_failed", "published", "revoked"] as const;
...
export interface ScanReport { readonly id: string; readonly toolVersionId: string; readonly verdict: "clean" | "findings" | "blocked" | "errored"; readonly findings: readonly import("./package-scan").ScanFinding[]; readonly scannerVersion: string; readonly durationMs: number; readonly scannedAt: string; }
