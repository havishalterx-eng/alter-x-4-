...
export function loadSandboxEnvironment(environment: NodeJS.ProcessEnv): SandboxEnvironment {
  ...
  if (required(environment, "ALTER_SERVICE_NAME") !== "sandbox-service") throw new Error("ALTER_SERVICE_NAME must equal sandbox-service");
