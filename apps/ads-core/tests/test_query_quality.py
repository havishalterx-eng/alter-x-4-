...
def test_context_reconstruction_uses_only_returned_chunk_text_in_stable_order() -> None:
    later = _hit(chunk_id="chk_b", context="second source chunk", semantic=0.8, keyword=0.0)
    earlier = _hit(chunk_id="chk_a", context="first source chunk", semantic=0.8, keyword=0.0)
